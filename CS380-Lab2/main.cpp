...
static void keyboard_callback(GLFWwindow* window, int key, int scancode, int action, int mods){
	if(action == GLFW_PRESS){
		...
		switch(key){
			case GLFW_KEY_A:
				m = rotate(mat4(1.0f), 1.0f, vec3(0.0f, 1.0f, 0.0f));
				break;
			case GLFW_KEY_S:
				m = rotate(mat4(1.0f), -1.0f, vec3(1.0f, 0.0f, 0.0f));
				break;
			case GLFW_KEY_D:
				m = rotate(mat4(1.0f), -1.0f, vec3(0.0f, 1.0f, 0.0f));
				break;
			case GLFW_KEY_W:
				...
				break;
			case GLFW_KEY_KP_6:
				m = translate(mat4(1.0f), vec3(0.1f, 0.0f, 0.0f));
				break;
			case GLFW_KEY_KP_8:
				m = translate(mat4(1.0f), vec3(0.0f, 0.0f, -0.1f));
				break;
			case GLFW_KEY_KP_4:
				m = translate(mat4(1.0f), vec3(-0.1f, 0.0f, 0.0f));
				break;
			case GLFW_KEY_KP_2:
				...
				break;
			case GLFW_KEY_KP_5:
				m = translate(mat4(1.0f), vec3(0.0f, 0.1f, 0.0f));
				break;
			case GLFW_KEY_KP_0:
				m = translate(mat4(1.0f), vec3(0.0f, -0.1f, 0.0f));
				break;
