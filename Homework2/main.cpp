...
vec2 mousePosCur, mousePosPrev;
bool arcBallExists, leftMousePressed = false, rightMousePressed = false, middleMousePressed = false;
quat arcBallQuat;
...
int main(void){
	...
	do{
		...
		if(arcBallExists){
			// TODO: object manipulation through mouse interaction rotation part
		}
		redCube.draw();
		greenCube.draw();
		ground.draw();
